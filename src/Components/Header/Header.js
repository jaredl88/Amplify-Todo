...
const Header = (props) => {
  ...
  return (
   ...
   <div class="navbar" >
  <div class="flex-1">
  <button class="btn shadow-xl" onClick={Home}><NavLink exact activeClassName="active"  to="/">Home</NavLink></button>
  </div>
  <div class="flex-none visible hover:invisible">
    ...
    <div class="flex-1 right-0">
      <button class="btn shadow-xl" onClick={Login}><NavLink exact activeClassName="active" to="/Login">Login</NavLink></button>
      </div>
      :
      <div class="flex-1 right-0">
      <button class="btn shadow-xl" onClick={Logout}>Logout</button>
      </div>
      }
      </div>
  </div>
