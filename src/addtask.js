...
const apiUrl = 'https://j2b30glms2.execute-api.us-east-1.amazonaws.com/prod/addtask';
  ...
  <form onSubmit={submitHandler}>
    <h2 class="card-title shadow-xl"><p class="text-black-500">Add New Task</p></h2>
    <p><input type="text" placeholder="Task Name" class="input input-bordered input-xl w-full max-w-xs m-2 w-48" value={tName} onChange={event=> setTName(event.target.value)}/><br/><textarea type="text" placeholder="Task Description" class="textarea textarea-bordered w-52 h-52" value={tTxt} onChange={event=> setTxt(event.target.value) } /> <br/></p>
